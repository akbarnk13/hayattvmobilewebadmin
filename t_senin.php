    ...
    <div class="container mt-2">
        <div class="card">
            <div class="card-header">
                <h4>
                    Senin
                    <a href="ambil_acara.php" class="btn btn-primary float-end"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="code.php" method="POST">
                                                <a href="senin-edit-jadwal.php?id=<?= $key; ?>" class="btn btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="senin_btn_hapus" value="<?= $key ?>" class="btn btn-danger">Hapus</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
