    ...
    <div class="container mt-2">
        <div class="card">
            <div class="card-header">
                <h4>
                    Selasa
                    <a href="ambil_acara_selasa.php" class="btn btn-primary float-end"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
            ...
            <div class="card-body">
                <div class="card-body">
                    <table class="table table-striped table-hover table-bordered table-responsive" id="selasa">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="code.php" method="POST">
                                                <a href="selasa-edit-jadwal.php?id=<?= $key; ?>" class="btn btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="selasa_btn_hapus" value="<?= $key ?>" class="btn btn-danger">Hapus</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
