            ...
            <div class="card">
                ...
                <?php
                    ...
                    <div class="form-group mb-3">
                                    ...
                                    <a href="ambil_acara_kamis.php" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" name="kamis_simpan_jadwal" class="btn btn-primary ">Simpan</button>
                        </div>
                    </form>
